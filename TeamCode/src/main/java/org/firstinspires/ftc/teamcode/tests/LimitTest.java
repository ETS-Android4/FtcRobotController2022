...
public class LimitTest extends LinearOpMode {
    public static double servoPosbl, servoPosbr, servoPosfl, servoPosfr = 0.1;
    @Override
...
//        motor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        Servo bl = hardwareMap.get(Servo.class, "backleft"); // change to servo name
...
//
        while (opModeIsActive()) {
            bl.setPosition(servoPosbl);
            telemetry.addData("posbl: ", bl.getPosition());

            br.setPosition(servoPosbr);
            telemetry.addData("posbr: ", br.getPosition());

            fl.setPosition(servoPosfl);
            telemetry.addData("posfl: ", fl.getPosition());

            fr.setPosition(servoPosfr);
            telemetry.addData("posfr: ", fr.getPosition());
//            //
